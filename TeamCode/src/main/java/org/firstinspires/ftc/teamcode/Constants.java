...
public class Constants {
    ...
    public static final double wristDown = 0.70;
    ...
    public static final int armNear = 300;
    public static final int armBackUpPos = 1050;
    public static final int armBackLowPos = 1260;
    public static final int armBackGroundPos = 1850;
    public static final int armDunk = 100;
    ...
    public static final double driveSpeedIntake = 0.55;
    public static final double driveSpeedIntakeSlow = 0.35;
    public static final double driveSpeedManeuvering = 0.75;
